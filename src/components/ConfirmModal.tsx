...
const ConfirmModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] flex flex-col overflow-hidden">
        <div className="p-6 sm:p-8 overflow-y-auto">
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={onCancel} className="text-slate-400 hover:text-slate-600 transition-colors flex-shrink-0">
              <X className="w-6 h-6" />
            </button>
          </div>
        ...
        <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex flex-wrap justify-end gap-3 flex-shrink-0">
          <button 
            onClick={onCancel}
