...
const CLIENT_STATS = [
  { icon: CheckCircle, value: 'Grátis', label: 'Para pedir orçamento' },
  { icon: ShieldCheck, value: 'Verificados', label: 'Documentos conferidos' },
  { icon: MessageSquare, value: 'Direto', label: 'Chat sem intermediário' },
  { icon: MapPin, value: 'Nacional', label: 'Atendimento em todo o Brasil' },
];

const PRO_STATS = [
  { icon: Percent, value: '0%', label: 'de comissão sobre o serviço' },
  { icon: Coins, value: 'Você decide', label: 'em quais pedidos investir' },
  { icon: ShieldCheck, value: '3x', label: 'mais contato com o selo Verificado' },
  { icon: MapPin, value: 'Seu raio', label: 'você escolhe onde atuar' },
];

const CLIENT_FAQS = [
  {
    q: 'É gratuito fazer um pedido?',
    a: 'Sim. Você não paga nada para publicar um pedido, receber orçamentos e conversar com os profissionais pelo chat.',
  },
  {
    q: 'Como sei se o profissional é confiável?',
    a: 'Veja o selo "Verificado" no perfil (documentos conferidos pela nossa equipe) e leia as avaliações de outros clientes antes de fechar negócio.',
  },
  {
    q: 'Como funciona o pagamento do serviço?',
    a: 'O pagamento é combinado direto entre você e o profissional. A plataforma não retém valores nem cobra comissão sobre o serviço.',
  },
];

const PRO_FAQS = [
  {
    q: 'O que são Diamantes?',
    a: 'É a moeda da plataforma: você usa Diamantes só nos pedidos que quiser atender, para desbloquear o contato do cliente e enviar sua proposta.',
  },
  {
    q: 'Vocês cobram comissão sobre o serviço fechado?',
    a: 'Não. 100% do valor que você negociar e receber do cliente é seu — sem mensalidade e sem comissão.',
  },
  {
...
const Home = () => {
  ...
  // "Lado" da plataforma que a home mostra — controlado pelo seletor do topo (Navbar).
          ...
          {audience === 'client' ? (
            <>
              ...
              <section className="relative overflow-hidden">
                <div className="container mx-auto max-w-7xl px-4 flex flex-col md:flex-row items-center gap-10 py-8 md:py-16">
                  <div className="flex-1 text-left z-10">
                    <h1 className="text-4xl md:text-6xl font-extrabold text-blue-950 tracking-tight leading-tight mb-6">
                    ...
                    <div className="flex flex-wrap gap-4">
                      ...
                      <Link to="/login" className="bg-white hover:bg-blue-50 text-blue-900 px-8 py-4 rounded-xl font-bold text-lg border border-blue-200 transition-all shadow-sm">
                        Já tenho conta
                      </Link>
                    </div>
                  </div>
              ...
              <section className="container mx-auto max-w-7xl px-4">
                <div className="text-center mb-10">
                  <h2 className="text-3xl font-extrabold text-blue-950 mb-3">Explore por categoria</h2>
                  <p className="text-slate-500 text-lg">Encontre o profissional certo para cada tipo de serviço.</p>
                </div>
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
                  {CATEGORY_MENUS.map((cat) => (
                    <Link
                      ...
                      className="group relative rounded-2xl overflow-hidden aspect-[3/4] shadow-sm hover:shadow-xl transition-all hover:-translate-y-1"
                    >
                      <img
                        src={cat.image}
                        alt={cat.name}
              ...
              {/* Selos de confiança */}
              <section className="container mx-auto max-w-7xl px-4">
                <div className="bg-blue-950 rounded-3xl py-10 px-6 md:px-12">
              ...
              <section className="max-w-4xl mx-auto px-4">
                <div className="text-center mb-10">
                  <h2 className="text-3xl font-extrabold text-blue-950 mb-3 flex items-center justify-center gap-2">
                    <HelpCircle className="w-8 h-8 text-primary" /> Perguntas frequentes
                  </h2>
                  <p className="text-slate-500 text-lg">Tire suas dúvidas antes de pedir um orçamento.</p>
                </div>
                <div className="space-y-4">
                  {CLIENT_FAQS.map((faq) => (
                    <div key={faq.q} className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                ...
                <div className="text-center mt-8">
                  <Link to="/help" className="inline-flex items-center gap-2 text-primary font-bold hover:underline">
                    Ver a Central de Ajuda completa <ChevronRight className="w-4 h-4" />
                  </Link>
                </div>
              </section>
            </>
            ...
            <>
              ...
              <section className="relative overflow-hidden">
                <div className="container mx-auto max-w-7xl px-4 flex flex-col md:flex-row items-center gap-10 py-8 md:py-16">
                  <div className="flex-1 text-left z-10">
                    <h1 className="text-4xl md:text-6xl font-extrabold text-blue-950 tracking-tight leading-tight mb-6">
                      Receba pedidos de serviço<br />
                      <span className="text-orange-500">na sua região.</span>
                    </h1>
                    <p className="text-xl text-slate-600 max-w-2xl mb-10">
                      Veja todos os pedidos de graça, escolha só os que valem a pena e negocie direto com o cliente. Sem mensalidade e sem comissão sobre o serviço.
                    </p>

                    <div className="flex flex-wrap gap-4">
                      <Link to="/register?role=professional" className="bg-blue-900 hover:bg-blue-950 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all shadow-lg shadow-blue-900/30">
              ...
              {/* Categorias que você pode atender */}
              <section className="container mx-auto max-w-7xl px-4">
                <div className="text-center mb-10">
                  <h2 className="text-3xl font-extrabold text-blue-950 mb-3">Categorias que você pode atender</h2>
                  <p className="text-slate-500 text-lg">Cadastre os serviços que você presta em uma ou mais categorias.</p>
                </div>
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
                  {CATEGORY_MENUS.map((cat) => (
                    <Link
              ...
              <section className="text-center max-w-5xl mx-auto">
                ...
                <div className="mt-12">
                  <Link to="/register?role=professional" className="inline-block bg-blue-900 text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-blue-950 transition-all shadow-lg shadow-blue-900/30">
                    Cadastre-se como Profissional
                  </Link>
                </div>
              </section>

              {/* Por que trabalhar com o Conecta Serviço? */}
              <section className="py-20 bg-white">
                <div className="container mx-auto max-w-7xl px-4">
                  <div className="text-center mb-16">
                    <h2 className="text-3xl font-extrabold text-blue-950 mb-4">Por que trabalhar com o Conecta Serviço?</h2>
                    <p className="text-slate-500 text-lg max-w-2xl mx-auto">
                      Feito para o profissional autônomo crescer: mais visibilidade, controle do próprio tempo e nenhuma taxa escondida.
                    </p>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-8">
                    <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100 hover:shadow-lg transition-all hover:-translate-y-1">
                      ...
                      <h3 className="text-xl font-bold text-blue-950 mb-4">Clientes toda hora</h3>
                      <p className="text-slate-600 leading-relaxed">
                        Pedidos novos chegam o dia todo na sua região. Você define o raio de atuação e recebe um aviso quando algo combina com os seus serviços.
                      </p>
                    </div>
                    ...
                    <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100 hover:shadow-lg transition-all hover:-translate-y-1">
                      ...
                      <h3 className="text-xl font-bold text-blue-950 mb-4">Você no controle do gasto</h3>
                      <p className="text-slate-600 leading-relaxed">
                        Sem mensalidade. Você só usa Diamantes nos pedidos que realmente quer atender e fica com 100% do valor combinado com o cliente.
                      </p>
                    </div>
                    ...
                    <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100 hover:shadow-lg transition-all hover:-translate-y-1">
                      ...
                      <h3 className="text-xl font-bold text-blue-950 mb-4">Selo de confiança</h3>
                      <p className="text-slate-600 leading-relaxed">
                        Valide seus documentos uma vez e ganhe o selo verificado. Perfis verificados recebem até 3x mais contatos para orçamento.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <section className="bg-orange-50 rounded-3xl p-8 md:p-12 border border-orange-100">
                <div className="flex flex-col md:flex-row items-center gap-10">
                  <div className="flex-1 space-y-6">
                    <h2 className="text-3xl font-extrabold text-blue-950">Dicas para conseguir mais pedidos</h2>
                    <p className="text-slate-600 text-lg">
                      Pequenos cuidados fazem diferença na hora do cliente escolher quem chamar:
                    </p>
                    <ul className="space-y-4">
                      <li className="flex gap-3">
                        <CheckCircle className="w-6 h-6 text-orange-500 flex-shrink-0" />
                        <span className="text-blue-950/80 font-medium">Complete seu perfil com foto e documentos validados — o selo Verificado passa mais confiança.</span>
                      </li>
                      <li className="flex gap-3">
                        <Clock className="w-6 h-6 text-orange-500 flex-shrink-0" />
                        <span className="text-blue-950/80 font-medium">Responda rápido: os primeiros profissionais a entrar em contato têm mais chance de fechar o serviço.</span>
                      </li>
                      <li className="flex gap-3">
                        <Star className="w-6 h-6 text-orange-500 flex-shrink-0" />
                        <span className="text-blue-950/80 font-medium">Peça para o cliente te avaliar ao final. Boas avaliações aparecem no seu perfil público.</span>
                      </li>
                    </ul>
                  </div>
                  <div className="w-full md:w-1/3">
                    <img src="https://images.unsplash.com/photo-1556740758-90de374c12ad?auto=format&fit=crop&w=600&q=80" alt="Profissional atendendo um cliente" className="rounded-2xl shadow-lg w-full border-4 border-white" />
                  </div>
                </div>
              </section>
              ...
              <section className="max-w-4xl mx-auto px-4">
                <div className="text-center mb-10">
                  ...
                  <p className="text-slate-500 text-lg">Tire suas dúvidas antes de se cadastrar.</p>
                </div>
                <div className="space-y-4">
                  {PRO_FAQS.map((faq) => (
                    <div key={faq.q} className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
